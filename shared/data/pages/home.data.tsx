...
import heroImg1_1 from "~/assets/images/hero1-1.png";
import heroImg1_2 from "~/assets/images/hero1-2.png";
import heroImg2_1 from "~/assets/images/hero2-1.jpg";
import heroImg2_2 from "~/assets/images/hero2-2.png";
import company from "~/assets/images/company-logos/CompanyLogo.svg";
import company2 from "~/assets/images/company-logos/CompanyLogo2.svg";
import company3 from "~/assets/images/company-logos/CompanyLogo3.svg";
import company4 from "~/assets/images/company-logos/CompanyLogo4.svg";
import company5 from "~/assets/images/company-logos/CompanyLogo5.svg";
import company6 from "~/assets/images/company-logos/CompanyLogo6.svg";
import company7 from "~/assets/images/company-logos/CompanyLogo7.svg";
import company8 from "~/assets/images/company-logos/CompanyLogo8.svg";
...
// Infinite Logo Banner on Home page ****************
export const logoBannerHome: LogoBannerProps = {
  logos: [
    {
      src: company,
      alt: "Company Logo",
...
export const featuresHome: FeaturesProps = {
  ...
  header: {
    title: (
      <>
        What you get with <span className="whitespace-nowrap">Inflead</span>
      </>
    ),
    subtitle:
  ...
  items: [
    {
      title: "Ready-to-use",
      description:
        "Widgets ready to be used in Marketing, Personal Profiles, Small Business...",
      icon: IconComponents,
      callToAction: {
        text: "Discover now",
        href: "/",
...
export const callToAction2Home: CallToActionProps = {
  title: "Get started with Inflead",
  subtitle:
